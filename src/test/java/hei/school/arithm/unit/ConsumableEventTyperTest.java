package hei.school.arithm.unit;
...
import hei.school.arithm.conf.FacadeIT;
import hei.school.arithm.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.arithm.endpoint.event.consumer.model.ConsumableEventTyper;
import hei.school.arithm.endpoint.event.consumer.model.TypedEvent;
import hei.school.arithm.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("hei.school.arithm.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("hei.school.arithm.endpoint.event.model.UuidCreated", payload);
