package hei.school.arithm.endpoint.event.model;

import static hei.school.arithm.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.arithm.PojaGenerated;
import hei.school.arithm.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.school.arithm.event1";
    return "hei.school.arithm.event2";
  }
}
